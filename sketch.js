...
//     fill("#FF1E6")
//     noStroke()
//     ellipse(0,0+map(m_y,0,height,-10,12),400,300)
//     ellipse(-25,40+map(m_y,0,height,-10,12),400,220)
//     ellipse(-10,0+map(m_y,0,height,-10,12),400,300)//左
//     ellipse(200,-20+m_y/20,90,30)//up tail
//     ellipse(200,0+m_y/20,100,30)//down tail
